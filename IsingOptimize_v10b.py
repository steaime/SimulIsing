...
if (SAMPLE_SEL == 'LUDOX45'):
    ...
    if defAlphaNoiseType==2:
        ...
        # These parameters don't mean anything
        defGnorm = [0.7]
        defAVar = [0.18]
    defNoiseG = False
    defOmega = 3.14
    ...
    defTau0 = [1630]
    defAAvg = [None]#[7000]
    defAVar = [0.002],#[0.0015, 0.002, 0.003, 0.004]#[0.006]
    defGnorm = [0.98]
    defOmega = 6.28
    defGammaMin = 0.01
    defGammaMax = 0.2
    ...
    defTau0 = [1500]
    defAAvg = [None]#[488.2]
    defAVar = [0.00002, 0.00005, 0.0001, 0.0002]
    defGnorm = [0.995]
    defOmega = 6.28
    defGammaMin = 0.03
    defGammaMax = 0.3
...
SaveRoot        = os.path.join(data_root, 'v4', SAMPLE_SEL, save_subfolder)
...
if __name__ == '__main__':
    ...
    params = {
                ...
                'wChi'              : 100.0,
                'dComb'             : True,
                'saveRateHist'      : defSaveRateHist,
                'saveAlphaHist'     : defSaveAlphaHist,
                'printRateSTD'      : defPrintRateSTD,
                'printNLoops'       : defPrintNLoops,
                'saveRawSnapshots'  : defSaveRawSnapshots,
                'maxIterations'     : defMaxNumIterations,
            }
